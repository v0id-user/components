    ...
    <section className="py-8">
      ...
      <div className="card-body">
        <p className="mb-4">
          ...
          هنا أجمع المكونات اللي أطورها من وقت لآخر، خصوصًا لما أحتاج شيء مب متوفر في المكتبات المعروفة. أحيانًا يكون فيه احتياج لمكوّن معين، وما ألقاه جاهز أو ما يعجبني اللي موجود، فأسويه بنفسي وأستخدمه في مشاريعي المختلفة.
        </p>
        <p className="mb-4">
